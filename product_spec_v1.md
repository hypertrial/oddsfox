...
| Misleading similarities | Include distinct sources, units, observation times, strict versus inclusive thresholds, and settlement exceptions. No known false equivalence may remain accepted. Demonstrate at least one unanimous evaluator-panel cross-venue relationship and one unanimous evaluator-panel near-match rejection in the frozen corpus. |
